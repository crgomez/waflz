...
#define WAFLZ_SERVER_HEADER_INSTANCE_ID "x-ec-waf-instance-id"
//: ****************************************************************************
//: ----------------------------------------------------------------------------
//:                           request handler
//: ----------------------------------------------------------------------------
...
int main(int argc, char** argv)
{
        ...
        // -------------------------------------------------
#ifdef ENABLE_PROFILER
        char l_short_arg_list[] = "hvr:i:d:f:m:p:g:s:xbt:H:C:";
#else
        char l_short_arg_list[] = "hvr:i:d:f:m:p:g:s:xbt:";
#endif
