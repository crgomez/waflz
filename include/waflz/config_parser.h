...
private:
        ...
        int32_t add_rule(waflz_pb::sec_config_t &ao_config, const kv_list_t &a_variable_list, const std::string &a_operator_fx, const std::string &a_operator_match, const kv_list_t & a_action_list, bool a_operator_is_negated);
