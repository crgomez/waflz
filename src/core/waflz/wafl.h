...
public:
        ...
        int32_t init_line(wafl_parser::format_t a_format, const std::string &a_line);
        // Settings .....
        ...
        const waflz_pb::sec_config_t *get_config(void) { return m_config; }
        // -------------------------------------------------
        // process
        // -------------------------------------------------
        // -------------------------------------------------
